...
-l"D:\workspace_v8\zhou\20180703\master\Debug\configPkg\package\cfg\clientAndSRIO_pe66.oe66"
...
-l"C:\ti\pdk_C6678_1_1_2_6\packages\ti\drv\srio\lib\ti.drv.srio.ae66"
...
/* Content from ti.platforms.my6678EVMhxl (null): */
...
SECTIONS
{
    ti.sdo.ipc.SharedRegion_0:  { . += 0x80000;} run > 0xc100000, type = NOLOAD
}
...
SECTIONS
{
    ...
    .fpgaData0: load > 0xc010000, fill = 0xff
    .fpgaData1: load > 0xc020000, fill = 0xff
    .dataValidtest: load > 0xc030000, fill = 0xff
    .sharedVar: load >> MSMCSRAM align = 0x80
    .sharedVar1: load >> DDR3 align = 0x80
    .PCParasVars: load >> L2SRAM align = 0x8
    .csl_vect: load >> DDR3
    .filterVars: load >> MSMCSRAM align = 0x8
    .filterVars1: load >> DDR3 align = 0x8
    .FFTVars: load >> DDR3 align = 0x8
    .shared: load >> MSMCSRAM align = 0x8
